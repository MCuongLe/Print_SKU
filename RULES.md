...
- Sửa quét nhầm ngay trên danh sách: nút `−` bớt 1 mẫu (bao còn đúng 1 mẫu thì bị xoá hẳn vì bao rỗng vô nghĩa), nút `×` xoá hẳn bao và hỏi xác nhận trước.
