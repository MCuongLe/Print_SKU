-- Fabric Relaxation v2: 1–5 mã hàng trên một tem; tương thích job v1 đang chờ.
begin;
...
begin
  ...
  select * into v_job from public.print_jobs where status='queued' and (
    ...
    (type='fabric_relaxation' and template_version=2 and 'fabric_relaxation:v2'=any(v_cap))
